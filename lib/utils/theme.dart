...
class AppThemeData {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.light(primary: appColorPrimary, primaryContainer: appColorPrimary).copyWith(error: Colors.red),
  ).copyWith(
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.dark(primary: appBackgroundColorDark, onPrimary: cardBackgroundBlackDark, primaryContainer: color_primary_black).copyWith(secondary: whiteColor).copyWith(error: Color(0xFFCF6676)),
  ).copyWith(
    pageTransitionsTheme: PageTransitionsTheme(builders: <TargetPlatform, PageTransitionsBuilder>{
      TargetPlatform.android: OpenUpwardsPageTransitionsBuilder(),
      TargetPlatform.iOS: CupertinoPageTransitionsBuilder(),
